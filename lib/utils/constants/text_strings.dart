class SlectivTexts {
  ...
  static const String onBoardingSubtitle1 =
      "The place for you to find the best photo studio in the city of Balikpapan";
  static const String onBoardingSubtitle2 =
      "High quality photos that will certainly create unforgettable moments";
  static const String onBoardingSubtitle3 =
      "Every moment will become a perfect memory at Slectiv Studio";
  ...
  static const String registerSuccessfullSubtitle =
      "Congratulations, your account has been successfully created. Please log in to continue.";
  static const String forgetPasswordWaitingToResetTitle =
      "Reset Password link has been sent.";
  static const String forgetPasswordWaitingToResetSubtitle =
      "Your account security is our priority! We've sent you a password reset link to safely change your password and keep your account protected.";
  static const String snackbarThereIsAnErrorTitle = "There is an error";
  static const String snackbarUnableSendResetLink =
      "Unable to send password reset link.";
  static const String snackbarInvalidEmail =
      "The email you entered is invalid.";
  static const String snackbarErrorTitle = "Error";
  static const String snackbarErrorSubtitle =
      "Email or Password cannot be empty";
  static const String snackbarLoginSuccessfulTitle = "Login Successful";
  static const String snackbarLoginfailedSubtitle =
      "Login failed. Please check your email and password.";
  static const String snackbarLoginSuccessfulSubtitle =
      "Congratulations, You have logged in successfully";
  static const String snackbarIncorrectEmailSubtitle =
      "Congratulations, You have logged in successfully";
  static const String snackbarErrorRegistrationSubtitle =
      "An error occurred during registration. Please try again.";
  static const String snackbarErrorUpdateNameSubtitle =
      "Failed to update name:";
  static const String snackbarErrorNotCompleteAllColumnSubtitle =
      "Please complete all columns first.";
  static const String snackbarErrorNotValidEmailSubtitle =
  ...
  static const String selfPhotoDescription =
      "Our Self Photo service aims to showcase your unique personality. Whether you need professional headshots, family portraits, or a personal photo shoot, we create images that reflect the true you. We work with you to showcase your best angles and expressions, ensuring every portrait tells your story.";
  ...
  static const String widePhotoboxDescription =
      "Capture every moment with our Wide Photobox service. Whether it's a family gathering, a corporate event, or a special celebration, our wide-format photography ensures no one is left out of the frame. We bring your events to life with stunning clarity and detail, creating memories that last a lifetime.";

  // -- Photobooth
  static const String photoboothTitle = "Photo booth";
  static const String photoboothButtonName = "Contact Us";
  static const String photoboothDescription =
  ...
  static const String profileSuccessLogoutSubtitleButton =
  ...
  static const String profileErrorFetchingUserData =
  ...
  static const String profileConfirmExitMessage =
  ...
  static const String chooseDate =
      "Choose a date above to see available times.";
  static const String errorBookingValidationTitle = "Error";
  static const String errorBookingValidationSubtitle =
      "Please select all options before booking.";
